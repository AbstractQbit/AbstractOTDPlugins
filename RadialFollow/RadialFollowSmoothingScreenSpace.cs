...
{
    [PluginName("AbstractQbit's Radial Follow Smoothing (Screen coordinates)")]
    public class RadialFollowSmoothingScreenSpace : IPositionedPipelineElement<IDeviceReport>
    {
        public RadialFollowSmoothingScreenSpace() : base() { }
        public PipelinePosition Position => PipelinePosition.Pixels;

        [Property("Outer Radius"), DefaultPropertyValue(5.0d), Unit("px"), ToolTip
        (
        ...
        [Property("Inner Radius"), DefaultPropertyValue(0.0d), Unit("px"), ToolTip
        (
